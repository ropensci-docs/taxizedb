...
By default `src_*` functions use a path to the cached database file. You
can alternatively pass in your own path if you’ve put it somewhere else.
...
All of these functions run very fast. It only takes a few seconds to
find all bacterial taxa and count them:
